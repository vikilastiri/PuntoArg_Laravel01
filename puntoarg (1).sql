...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-07-2019 a las 20:40:26
...
INSERT INTO `carts` (`id`, `name`, `description`, `price`, `cant`, `user_id`, `status`, `cart_number`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, '.ARG PASS 3 dias', 'ffffffffffffffffffffffff', '2000.00', 1, 1, 1, 1, '2019-07-04 20:40:28', '2019-07-04 20:44:50', NULL),
(2, '.ARG PASS 3 dias', 'ffffffffffffffffffffffff', '2000.00', 1, 1, 1, 1, '2019-07-04 20:40:33', '2019-07-04 20:44:50', NULL),
(3, '.ARG PASS 7 Días', 'gfgjdlghljfhgjfghfjkhgjfhchngcxjdskhvckdxcnvcjkdvjhbndjcvhd\r\njgjhfhjfjhgfjhfghfjhgfhgfdsjhgfdhgfd', '5000.00', 1, 1, 1, 1, '2019-07-04 20:43:16', '2019-07-04 20:44:50', NULL),
(4, '.ARG PASS 7 Días', 'gfgjdlghljfhgjfghfjkhgjfhchngcxjdskhvckdxcnvcjkdvjhbndjcvhd\r\njgjhfhjfjhgfjhfghfjhgfhgfdsjhgfdhgfd', '5000.00', 1, 1, 0, NULL, '2019-07-04 21:03:36', '2019-07-04 21:17:26', '2019-07-04 21:17:26'),
(5, '.ARG PASS 3 dias', 'ffffffffffffffffffffffff', '2000.00', 1, 1, 0, NULL, '2019-07-04 21:03:49', '2019-07-04 21:03:49', NULL);
...
(1, 'Victoria', 'vikilastiri@gmail.com', NULL, '$2y$10$h.JRXD7VAdM501FmRwb4EeUY8QpRALZJ.jlk6mxaCnxDcIHHXP62O', NULL, '2019-07-04 20:04:26', '2019-07-04 20:04:26', NULL);
...
(2, '.ARG PASS 7 Días', 'gfgjdlghljfhgjfghfjkhgjfhchngcxjdskhvckdxcnvcjkdvjhbndjcvhd\r\njgjhfhjfjhgfjhfghfjhgfhgfdsjhgfdhgfd', '5000.00', 'AnzL4k6LDgTYjznrUayQ9M9O5Is3uVMkzsPeuYdd.jpeg', '2019-07-04 20:15:58', '2019-07-04 20:15:58', NULL);
...
ALTER TABLE `carts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `carts_voucher_id_foreign` (`user_id`);
...
--
ALTER TABLE `carts`
  ADD CONSTRAINT `carts_voucher_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `vouchers` (`id`);
COMMIT;
